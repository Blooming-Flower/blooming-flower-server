...
public class PassageService {
	...
	public SearchPassageDto searchPassageInfo(long passageId) {
		...
		for (Entry<String, List<QuestionEntity>> entry : groupByCode.entrySet()) {
			...
			searchQuestionDtos.setQuestionContent(questionByCode.get(0).getQuestionContentEntity().getQuestionContent());
	...
	private void setPassageEntity(PassageEntity passageEntity, PassageRegistParam passageRegistParam) {
