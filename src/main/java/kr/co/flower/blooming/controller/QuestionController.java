...
public class QuestionController {
	...
	public ResponseEntity<?> searchPassageNumbers(Pageable pageable, PassageType passageType, String passageYear,
			String passageName) {
		return ResponseEntity.ok(questionService.searchPassageNumbers(pageable, passageType, passageYear, passageName));
	}

	@Operation(description = "지문 유형과 연도에 해당되는 교재명 목록 조회", summary = "[문제 출제] 지문 유형과 연도에 해당되는 교재명 목록 조회")
